...
Here are some articles explaining how to write simple and compound select statements as well as other statements in `seaquell`.

* <<Select.adoc#, Select>>
* <<Compound-Select.adoc#, Compound Select>>
* <<Examples.adoc#, Other statements>>
...
Check out the <<Examples.adoc#, statement index>> for useful links related to each type of statement.
...
This <<./org/org.adoc#, article>> gives an overview of how the code is organized.

== Designing Seaquell

<<./design/design.adoc#, Here>> are various thoughts regarding `seaquell` design rationale and direction.
